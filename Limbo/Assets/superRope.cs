...
public class Rope : MonoBehaviour
{
    ...
    [SerializeField, Tooltip("Optional: GameObject to lock the start of the rope to")] GameObject startPoint;
    [SerializeField, Tooltip("Optional: GameObject to lock the end of the rope to")] GameObject endPoint;
    ...
    {
        if (startPoint != null)
            currentNodePositions[0] = startPoint.transform.position;
        else
            currentNodePositions[0] = transform.position;

        if (endPoint != null)
            currentNodePositions[totalNodes - 1] = endPoint.transform.position;
